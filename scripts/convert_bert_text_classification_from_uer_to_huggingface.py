...
output_model["bert.pooler.dense.weight"] = input_model["output_layer_1.weight"]
output_model["bert.pooler.dense.bias"] = input_model["output_layer_1.bias"]
output_model["classifier.weight"] = input_model["output_layer_2.weight"]
output_model["classifier.bias"] = input_model["output_layer_2.bias"]
