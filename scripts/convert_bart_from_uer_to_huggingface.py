...
def main():
    ...
    output_model["model.decoder.embed_positions.weight"] = torch.cat((torch.zeros(2, emb_size), input_model["tgt_embedding.position_embedding.weight"]), 0)
    ...
    output_model["model.decoder.layernorm_embedding.weight"] = input_model["tgt_embedding.layer_norm.gamma"]
    output_model["model.decoder.layernorm_embedding.bias"] = input_model["tgt_embedding.layer_norm.beta"]
